...
exports.sendReportEmail = exports.sendWeeklyReport = void 0;
...
const transporter = nodemailer.createTransporter({
    ...
    secure: false,
    auth: {
        user: 'airspeedmanufacturing@gmail.com',
...
function generateWeeklyReportEmail(inboundData, outboundData) {
...
function generateCustomReportEmail(reportType, emailData) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
