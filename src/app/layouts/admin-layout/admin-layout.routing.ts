...
export const AdminLayoutRoutes: Routes = [
  ...
  { path: 'j-warehouse', loadChildren: () => import('../../pages/j-warehouse/j-warehouse.module').then(m => m.JWarehouseModule), canActivate: [AuthGuard, TabPermissionGuard], data: { preload: true, preloadDelay: 3000 } },
