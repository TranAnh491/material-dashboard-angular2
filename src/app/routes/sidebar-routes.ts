...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/inbound-asm1', title: 'RM1 Inbound', icon: 'input', class: '' },
  { path: '/inbound-asm2', title: 'RM2 Inbound', icon: 'input', class: '' },
  { path: '/outbound-asm1', title: 'RM1 Outbound', icon: 'output', class: '' },
  { path: '/outbound-asm2', title: 'RM2 Outbound', icon: 'output', class: '' },
  { path: '/materials-asm1', title: 'RM1 Inventory', icon: 'warehouse', class: '' },
  { path: '/materials-asm2', title: 'RM2 Inventory', icon: 'warehouse', class: '' },
