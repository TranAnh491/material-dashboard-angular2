...
export class InventoryOverviewASM2Component implements OnInit, OnDestroy {
  ...
  private async loadInventoryOverview(): Promise<void> {
    ...
    try {
      ...
      // 🔧 FIX: .get() khi mở tab / bấm Refresh — không listener realtime.
      ...
      this.readTracker.track('inventory-overview-asm2', 'inventory-materials', docs.length);
      console.log(`✅ Loaded ${docs.length} ASM2 documents (one-time read)`);
